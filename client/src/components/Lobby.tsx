    ...
    <PixelCard title="Lobby" className="w-full max-w-sm" nightMode={nightMode}>
      <div className="space-y-3 mt-2">
        {players.map((player) => (
          <div
            key={player.id}
            className={`flex items-center gap-3 p-2 border-2 transition-colors duration-700 cursor-pointer group ${
              nightMode
          ...
          >
            {/* Avatar */}
            <div
              className={`w-10 h-10 ${player.avatar} border-2 border-black flex items-center justify-center relative`}
            >
            ...
            <div className="flex-1">
              <div
                className={`font-display text-xs transition-colors duration-700 ${
              ...
              <div
                className={`font-body text-sm leading-none transition-colors duration-700 ${
        ...
        {/* Empty Slot */}
        <div
          className={`flex items-center justify-center gap-2 p-3 border-2 border-dashed font-body text-lg transition-colors duration-700 cursor-pointer ${
            nightMode
      ...
      <div
        className={`mt-4 pt-4 border-t-2 flex justify-between items-center transition-colors duration-700 ${
      ...
      >
        <div className="flex gap-2">
          ...
          <span
            className={`font-body transition-colors duration-700 ${
        ...
        <div
          className={`font-display text-[10px] transition-colors duration-700 ${
